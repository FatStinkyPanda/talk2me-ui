...
class PluginLifecycle:
    ...
    def __init__(self):
        ...
        self.plugin_states: dict[
            str, str
        ] = {}  # 'initializing', 'active', 'deactivating', 'inactive'

    async def activate_plugin(
        self, plugin_name: str, plugin_instance: PluginInterface, context: PluginLoadContext
    ) -> bool:
    ...
    def is_plugin_active(self, plugin_name: str) -> bool:
        ...
        """
        return (
            plugin_name in self.active_plugins and self.plugin_states.get(plugin_name) == "active"
        )
    ...
    async def reload_plugin(
        self, plugin_name: str, plugin_instance: PluginInterface, new_config: dict[str, Any]
    ) -> bool:
    ...
    async def validate_plugin_config(
        self, plugin_instance: PluginInterface, config: dict[str, Any]
    ) -> bool:
